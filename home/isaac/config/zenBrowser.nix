...
let
  # Script
  caelestiafoxApp = pkgs.writeShellScriptBin "caelestiafox" ''
    #!${pkgs.fish}/bin/fish
  ...
  nativeMessagingManifest = pkgs.writeTextFile {
    name = "caelestiafox-native-manifest";
    destination = "/lib/mozilla/native-messaging-hosts/caelestiafox.json";
