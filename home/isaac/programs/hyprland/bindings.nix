  ...
  wayland.windowManager.hyprland.settings = {
    ...
    bind =
      [
        ...
        (mkBind { key = ''"ALT + TAB"'';        dispatcher = ''hl.dsp.focus({ workspace = "previous" })''; })
        ...
        (mkBind { key = ''"CTRL + " .. mod .. " + Right"''; dispatcher = ''hl.dsp.focus({ workspace = "r+1" })''; })
        (mkBind { key = ''"CTRL + " .. mod .. " + Left"'';  dispatcher = ''hl.dsp.focus({ workspace = "r-1" })''; })
        (mkBind { key = ''mod .. " + mouse_up"'';   dispatcher = ''hl.dsp.focus({ workspace = "+1" })''; })
        (mkBind { key = ''mod .. " + mouse_down"''; dispatcher = ''hl.dsp.focus({ workspace = "-1" })''; })
      ...
      ++ (lib.concatLists (lib.genList
        (i:
          ...
          in
          [
            (mkBind { key = ''mod .. " + ${key}"'';            dispatcher = "hl.dsp.focus({ workspace = ${toString ws} })"; })
