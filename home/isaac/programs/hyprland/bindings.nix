  ...
  wayland.windowManager.hyprland.settings = {
    bind =
      [
        ...
        (mkBind { key = ''mod .. " + F"'';      dispatcher = ''hl.dsp.window.fullscreen({ mode = "maximize" })''; })   # fullscreen, 0
        ...
        (mkBind { key = ''"ALT + TAB"'';        dispatcher = ''hl.dsp.workspace.change("previous")''; })
        ...
        (mkBind { key = ''"CTRL + " .. mod .. " + Right"''; dispatcher = ''hl.dsp.workspace.change("r+1")''; })
        (mkBind { key = ''"CTRL + " .. mod .. " + Left"'';  dispatcher = ''hl.dsp.workspace.change("r-1")''; })
        (mkBind { key = ''mod .. " + mouse_up"'';   dispatcher = ''hl.dsp.workspace.change("+1")''; })
        (mkBind { key = ''mod .. " + mouse_down"''; dispatcher = ''hl.dsp.workspace.change("-1")''; })
      ...
      ++ (lib.concatLists (lib.genList
        (i:
          ...
          in
          [
            (mkBind { key = ''mod .. " + ${key}"'';            dispatcher = "hl.dsp.workspace.change(${toString ws})"; })
